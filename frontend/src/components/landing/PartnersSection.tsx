...
const PartnersSection = () => {
  ...
  const getPartnerImage = (partnerId: string) => {
    try {
      switch(partnerId) {
        case 'partner-1':
          return new URL('../../assets/partners/edufund-africa.png', import.meta.url).href;
        case 'partner-2':
          return new URL('../../assets/partners/green-harvest-coop.png', import.meta.url).href;
        case 'partner-3':
          return new URL('../../assets/partners/micro-enterprise-network.png', import.meta.url).href;
        default:
          return null;
      }
    } catch {
      ...
      <div className="container mx-auto px-3 md:px-6">
        ...
        >
          ...
          <p className="text-sm md:text-base text-muted-foreground max-w-2xl mx-auto px-2">
            We partner with established institutions that share our commitment to transparency and impact.
          </p>
        </motion.div>
              ...
              >
                <div className="w-16 h-16 md:w-20 md:h-20 bg-accent rounded-xl flex items-center justify-center mx-auto mb-3 md:mb-4 group-hover:bg-primary transition-colors overflow-hidden">
                  {getPartnerImage(partner.id) ? (
                    <img 
                      src={getPartnerImage(partner.id)} 
                      alt={partner.metadata?.name || 'Partner'}
