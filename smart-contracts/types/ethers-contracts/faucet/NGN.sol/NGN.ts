...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedLogDescription, TypedListener, TypedContractMethod } from "../../common.js"
  ...
  export interface NGNInterface extends Interface {
    getFunction(nameOrSignature: "MAX_MINT_AMOUNT" | "allowance" | "approve" | "balanceOf" | "decimals" | "faucet" | "name" | "symbol" | "totalSupply" | "transfer" | "transferFrom"): FunctionFragment;

    getEvent(nameOrSignatureOrTopic: "Approval" | "Transfer"): EventFragment;

    encodeFunctionData(functionFragment: 'MAX_MINT_AMOUNT', values?: undefined): string;
encodeFunctionData(functionFragment: 'allowance', values: [AddressLike, AddressLike]): string;
encodeFunctionData(functionFragment: 'approve', values: [AddressLike, BigNumberish]): string;
encodeFunctionData(functionFragment: 'balanceOf', values: [AddressLike]): string;
encodeFunctionData(functionFragment: 'decimals', values?: undefined): string;
encodeFunctionData(functionFragment: 'faucet', values: [AddressLike, BigNumberish]): string;
...
encodeFunctionData(functionFragment: 'transferFrom', values: [AddressLike, AddressLike, BigNumberish]): string;
    ...
    decodeFunctionResult(functionFragment: 'MAX_MINT_AMOUNT', data: BytesLike): Result;
...
decodeFunctionResult(functionFragment: 'transferFrom', data: BytesLike): Result;
  ...
  export interface NGN extends BaseContract {
    
    connect(runner?: ContractRunner | null): NGN;
    waitForDeployment(): Promise<this>;

    interface: NGNInterface;
  ...
  removeAllListeners<TCEvent extends TypedContractEvent>(event?: TCEvent): Promise<this>
    ...
    MAX_MINT_AMOUNT: TypedContractMethod<
      [],
      [bigint],
      'view'
    >
    ...
    getFunction(nameOrSignature: 'MAX_MINT_AMOUNT'): TypedContractMethod<
      [],
      [bigint],
      'view'
    >;
